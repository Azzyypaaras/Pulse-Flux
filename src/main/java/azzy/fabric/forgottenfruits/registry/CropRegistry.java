...
import static azzy.fabric.forgottenfruits.registry.ItemRegistry.CINDERMOTE_SEEDS;
import static azzy.fabric.forgottenfruits.registry.ItemRegistry.CLOUD_BERRY_SEEDS;

public class CropRegistry {

    public static final Block CLOUD_BERRY_CROP = register("cloud_berry_crop", new PlantBase(6, Material.PLANT, BlockSoundGroup.CROP, CLOUD_BERRY_SEEDS, 8, 16, null, 0, 0, 0, 0));
    public static final Block CLOUD_BERRY_WILD = register("cloud_berry_wild", new WildPlantBase("cloudberry", Material.PLANT, BlockSoundGroup.CROP, null, 0, 0, 0, 0));
