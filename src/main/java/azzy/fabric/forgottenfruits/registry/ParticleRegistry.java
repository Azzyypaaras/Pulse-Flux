...
public class ParticleRegistry {
    ...
    //    ((ParticleFactoryMixin) CAULDRON_BUBBLES).callRegisterFactory(CAULDRON_BUBBLES, (UnprotectedSpriteAwareFactory.SpriteAwareFactory)(azzy.fabric.forgottenfruits.render.particle.CauldronParticle::new));
    //}
