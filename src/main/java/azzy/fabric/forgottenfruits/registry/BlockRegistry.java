...
public class BlockRegistry {
    ...
    //Block Entities
    public static final Block PRESS_BLOCK = register("press_block", new PressBlock(null , Material.WOOD, BlockSoundGroup.WOOD, 0, DEFAULT_SHAPE), new Item.Settings().group(BLOCKENTITIES));
    public static final Block BASKET_BLOCK = register("basket_block", new BasketBlock(null, Material.WOOL, BlockSoundGroup.WOOL, 0, Block.createCuboidShape(1, 0, 1, 15, 8, 15)), new Item.Settings().group(BLOCKENTITIES).maxCount(1), true);
