...
public class BarrelBlock extends BaseMachine {
    ...
    public static final Identifier GID = new Identifier(MOD_ID, "barrel_gui");
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        ...
        if (blockEntity instanceof BarrelEntity) {
            ItemScatterer.spawn(world, pos, (BarrelEntity) blockEntity);
    ...
    public void addAllAttributes(World world, BlockPos pos, BlockState state, AttributeList<?> to) {
        ...
        if (be instanceof BarrelEntity) {
            to.offer(((BarrelEntity) be).fluidInv);
        }
    }
