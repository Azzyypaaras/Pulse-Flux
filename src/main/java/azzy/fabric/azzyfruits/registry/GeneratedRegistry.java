...
public class GeneratedRegistry {
    ...
    public static void init(){
        ...
        Biomes.NETHER_WASTES.addFeature(GenerationStep.Feature.VEGETAL_DECORATION, CINDERMOTE_FIELD.configure(new DefaultFeatureConfig()).createDecoratedFeature(Decorator.CHANCE_HEIGHTMAP.configure(new ChanceDecoratorConfig(1))));
    }
}
