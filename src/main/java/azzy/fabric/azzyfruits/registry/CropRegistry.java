...
public class CropRegistry {
    ...
    public static final Block CINDERMOTE_CROP = register("cindermote_crop", new CindermoteBlock("cindermote", 7, Material.ORGANIC, BlockSoundGroup.NETHER_WART, CINDERMOTE_SEEDS, 0, 16, ParticleTypes.FLAME, 20, 30, 0.05f, 8));
    public static final Block CINDERMOTE_WILD = register("cindermote_wild", new WildPlantBase("cindermote", Material.ORGANIC, BlockSoundGroup.NETHER_WART, ParticleTypes.FLAME, 10, 20, 0.05f, 30));
